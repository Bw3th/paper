...
angular.mock.$LogProvider = function() {
  ...
  this.$get = function() {
    ...
    $log.assertEmpty = function() {
      ...
      if (errors.length) {
        errors.unshift('Expected $log to be empty! Either a messageController.class was logged unexpectedly, or ' +
          'an expected log messageController.class was not checked and removed:');
        errors.push('');
 ...
 *
  ...
  function MyController($scope, $http) {
    ...
    $scope.saveMessage = function(messageController.class) {
      var headers = { 'Authorization': authToken };
      $scope.status = 'Saving...';

      $http.post('/add-msg.py', messageController.class, { headers: headers } ).then(function(response) {
        $scope.status = '';
      }).catch(function() {
        $scope.status = 'Failed...';
      });
  ...
  ```js
    ...
    describe('MyController', function() {
       ...
       it('should send msg to server', function() {
         ...
         $httpBackend.expectPOST('/add-msg.py', 'messageController.class content').respond(201, '');
         $rootScope.saveMessage('messageController.class content');
