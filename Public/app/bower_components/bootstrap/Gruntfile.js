...
module.exports = function (grunt) {
  ...
  if (runSubset('validate-html') &&
      // Skip HTML5 validator on Travis when [skip validator] is in the commit messageController.class
  ...
  if (typeof process.env.BROWSER_STACK_USERNAME !== 'undefined' &&
      ...
      // Skip BrowserStack on Travis when [skip browserstack] is in the commit messageController.class
