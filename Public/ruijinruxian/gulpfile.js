...
var paths = {
  sass: ['./scss/**/*.scss'],
  scripts: ['./www/lib/ionic/js/angular/angular-resource.min.js',
  './www/lib/ionic-close-popup/ionic-close-popup.js', '!./www/js/app.bundle.min.js','./www/js/*.js','./www/js/*.min.js'], // exclude the file we write too
  images: ['./www/img/**/*'],
  templates: ['./www/templates/**/*.html'],
  css: ['./www/lib/materialize/dist/css/materialize.min.css','./www/css/*.css','./www/css/*.min.css'],
  html: ['./www/index.html'],
  extras: ['./www/PushNotification.js'],
  ionicbundle: ['./www/lib/ionic/js/ionic.bundle.min.js'],
  ionicfonts: ['./www/lib/ionic/fonts/*'],
  iconfonts: ['./www/css/font/fonts/*','./www/font/**/*'],
  lib: ['./www/lib/ionic/js/angular/angular-resource.js', './www/lib/moment.min.js', './www/lib/bindonce.min.js'],
  dist: ['./dist/'],
  cleanfile:['./www/js/templates.js','./www/css/style.min.css','./www/css/ionic.app.css','./www/css/ionic.app.min.css']
};
var files = {
  jsbundle: 'app.bundle.min.js',
  appcss: 'style.css',
  distappcss: 'style.min.css'
};
