...
<head>
    ...
    <link href="/applecm/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/applecm/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/applecm/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/applecm/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/applecm/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/applecm/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/applecm/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/applecm/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/applecm/Public/Admin/js/jquery.mousewheel.js"></script>
    <!-- Bootstrap and necessary plugins -->
    <script type="text/javascript" src="/applecm/Public/static/angular/angular.min.js"></script>
    <script type="text/javascript" src="/applecm/Public/Admin/js/tether.min.js"></script>
    <script type="text/javascript" src="/applecm/Public/Admin/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/applecm/Public/Admin/js/pace.min.js"></script>

    <!-- Plugins and scripts required by all views -->
    <!-- <script type="text/javascript" src="/applecm/Public/Admin/js/Chart.min.js"></script> -->

    <script type="text/javascript" src="/applecm/Public/Admin/js/controller/main.js"></script>
    <!--<![endif]-->
...
<body>
    ...
    <div class="header">
        <!-- Logo -->
        <span class="logo"><?php echo C('WEB_SITE_TITLE');?>管理平台</span>
        <!-- /Logo -->
...
<script>
    ...
    <div class="page">
        ...
        <div class="cont-ft">
            <div class="copyright">
                <!-- <div class="copyright"> ©2015-2016 <?php echo C('WEB_SITE_TITLE');?>。 Powered by <a href="http://www.think-tec.com">Think-tec</a> </div> -->
                <div class="copyright"> ©2015-2016 <?php echo C('WEB_SITE_TITLE');?>。 Powered by <a href="">上海习业</a> </div>
            </div>
        </div>
    </div>
    <!-- /内容区 -->
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/applecm", //当前网站地址
            "APP"    : "/applecm/index.php?s=", //当前项目地址
            "PUBLIC" : "/applecm/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/applecm/Public/static/think.js"></script>
    <script type="text/javascript" src="/applecm/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
            var $window = $(window), $subnav = $("#subnav"), url;
            $window.resize(function(){
                $("#main").css("min-height", $window.height() - 89);
            }).resize();
...
<link href="/applecm/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/applecm/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/applecm/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/applecm/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/applecm/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
$(function(){
	//搜索功能
